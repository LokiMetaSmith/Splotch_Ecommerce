...
async function BootStrap() {
    console.log(`Initializing Square SDK with appId: ${appId}, locationId: ${locationId}`); // Added console.log
    try {
      ...
      try {
        ...
        // Use showPaymentStatus for user-facing error
        showPaymentStatus(`Failed to initialize Square card: ${e.message}`, 'error');
        console.error("Failed to initialize Square card:", e); // Keep console error for details
      }
}
BootStrap()
