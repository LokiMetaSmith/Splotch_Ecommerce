...
This guide provides comprehensive instructions for deploying the Print Shop application on a home server managed by Proxmox.

We offer two methods:
1.  **Automated VM Deployment (Script):** Uses a script to clone a cloud-init template and provision a full Virtual Machine.
2.  **Manual LXC Deployment:** Manually setting up lightweight LXC containers and Nginx Proxy Manager.

---

## Method 1: Automated VM Deployment (Script)
...
## Method 2: Manual LXC Deployment

This method involves manually setting up two separate, lightweight LXC containers on Proxmox:
